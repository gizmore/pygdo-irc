    ...
    async def gdo_execute(self) -> GDT:
        ...
        for name in self._irc_params[0].split(','):
            ...
            if self.is_own_user():
                ...
                # NAMES only reports presence. A JOIN is the authoritative
                # connection boundary for modules such as QuitJoin.
                await self._env_server.on_user_connected(self._env_user)
        return self.empty()
